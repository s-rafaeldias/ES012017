# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-23 01:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(blank=True, choices=[('M', 'Masculino'), ('F', 'Feminino'), ('N', 'Nao aplicavel')], max_length=1, null=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='propostasUsers',
            field=models.ManyToManyField(through='core.PropostaUser', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
